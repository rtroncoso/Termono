package com.quest.parser.handlers;
...
public class BaseTagHandler {
        ...
        public final boolean startTag(String uri, String localName, String qName, Attributes attributes)  throws SAXException {
                if (!mIsTagActive) {
        ...
        public final boolean endTag(String uri, String localName, String qName) throws SAXException {
                if (mIsTagActive) {
                        if (mTagDepth > 0) {
                                mTagDepth--;
                        }
