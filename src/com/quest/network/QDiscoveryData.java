...
public interface QDiscoveryData extends IDiscoveryData{
	...
	public class MatchesDiscoveryData implements IDiscoveryData {
		...
		public MatchesDiscoveryData(final byte[] pServerIP, final int pServerPort, String pTest) {
		...
		public final String getTest(){
			this.mTest = this.mTest.trim();
			String cleantest = ""; 
			for(int i=0;i<this.mTest.length();i+=2){
				cleantest=cleantest+this.mTest.substring(i,i+1);
			}
			return cleantest;
		}
		// ===========================================================
		...
		public void read(final DataInputStream pDataInputStream) throws IOException {
			...
			this.mTest = pDataInputStream.readLine();
		}
		...
		public void write(final DataOutputStream pDataOutputStream) throws IOException {
			...
			pDataOutputStream.writeChars(mTest);
		}
