...
public class MenuHud extends HUD{
		...
		private SpriteBatch mMenuBatch;
		...
		public MenuHud(Game pGame, HUD pHud){
				...
				public boolean onAreaTouched(TouchEvent pSceneTouchEvent,
					...
					switch(pSceneTouchEvent.getAction()) {
						...
						case TouchEvent.ACTION_DOWN:
							...
							if(updater == false) {		
								...
								MenuHud.this.mGame.getScene().registerUpdateHandler(pUpdatehandler = new IUpdateHandler() {
									...
									public void onUpdate(float pSecondsElapsed) {
										...
										if(MenuHud.this.mMenuBatch.getX() < 230){MenuHud.this.mGame.getScene().unregisterUpdateHandler(pUpdatehandler);}//updater=false;}// MenuHud.this.mMenuSprite.setPosition(MenuHud.this.mMenuSprite.getInitialX(), MenuHud.this.mMenuSprite.getInitialY());}

										MenuHud.this.mMenuBatch.setPosition(MenuHud.this.mMenuBatch.getX() - 20, MenuHud.this.mMenuBatch.getY() + 12);
							...
							} else if(updater == true) { updater = false; MenuHud.this.mMenuBatch.setPosition(MenuHud.this.mMenuBatch.getInitialX(), MenuHud.this.mMenuBatch.getInitialY()); }
			...
			this.mMenuBatch = new DynamicSpriteBatch(posX, -236, this.mMenuTextureAtlas, 2, this.mGame.getVertexBufferObjectManager()) {

				@Override

				public boolean onUpdateSpriteBatch() {

					this.draw(MenuHud.this.mMenuSprite);

					this.draw(MenuHud.this.mCancelSprite);

					MenuHud.this.mHud.registerTouchArea(MenuHud.this.mMenuSprite);
